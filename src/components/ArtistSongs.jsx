    ...
    >
      ...
      <div className="flex flex-1 items-center justify-between">
        ...
        <div className="mx-3 flex flex-1 flex-col justify-center">
          ...
          <p className="w-[250px] truncate text-base font-semibold text-gray-300  sm:w-auto">
            {song.albumName}
          </p>
        </div>
      </div>
...
const ArtistSongs = ({ data }) => {
  return (
    <div className="ml-0 mb-6 flex max-w-[90vw] flex-1 select-none flex-col md:max-w-[80vw] xl:ml-6 xl:mb-0 xl:max-w-[650px]">
      <div className="flex w-full flex-col">
        ...
        <div className="mt-4 flex flex-col gap-1">
          {Object.values(data?.resources.songs).map((song, i) => (
            <ArtistSongCard key={song.id} song={song.attributes} i={i} />
          ))}
        </div>
      </div>
    </div>
