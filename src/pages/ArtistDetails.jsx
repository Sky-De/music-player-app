...
const ArtistDetails = () => {
    // add fetch to redux for get real data--fixIt
    const data = artistDetailsTestData;
        ...
        <div className="flex flex-col">
          <div className="relative w-full flex flex-col mb-10">
             ...
             <div className="absolute inset-0 flex items-center">
               ...
               src={artistAvatarUrl}
                alt="art"
                className="object-cover sm:w-48 w-28 rounded-full border-2 shadow-xl shadow-black ml-2" />
